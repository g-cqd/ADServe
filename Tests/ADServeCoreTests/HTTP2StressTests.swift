...
// The h2 stress harness drives the server over the Network.framework TLS loopback (`LoopbackTLS`),
// which is Darwin-only; the portable HTTP/2 stress coverage lives in the HTTP package's own suites.
