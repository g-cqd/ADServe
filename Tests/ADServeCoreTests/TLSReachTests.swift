...
// Darwin-gated: the mTLS client presents a PKCS#12 identity through Security
// (SecPKCS12Import / URLCredential) and the UDS probe drives URLSession over the local
